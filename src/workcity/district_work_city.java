 ...
 * @author ahmad-soft
 */
public class district_work_city extends javax.swing.JFrame {

    /**
     * Creates new form district
     */
    public district_work_city() {
        initComponents();
        fullcombobox();
    ...
    public void fullcombobox() { 
        ArrayList<m_work_city> v = c.view_governorate_work_city();
        cmb_governorate.setModel(new DefaultComboBoxModel(v.toArray()));
    }

    public void full_district() {
        int id_governorate = ((m_work_city) cmb_governorate.getSelectedItem()).getId_governorate();
           Control.c_work_city a= new c_work_city();
        ArrayList<m_work_city> cc = a.view_district_work_city(id_governorate);
    ...
    private void initComponents() {
        ...
        N_type_of_doc_p.setText("الرجاء اختيار المحافظة لإضافة منطقة لها");
        ...
        pnl1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(N_type_of_doc_p2, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cmb_governorate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (tableDirect.getColumnModel().getColumnCount() > 0) {
            tableDirect.getColumnModel().getColumn(0).setResizable(false);
            tableDirect.getColumnModel().getColumn(1).setResizable(false);
        }
...
//
    ...
    private void btn_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add1ActionPerformed
        ...
        try {
            ...
            boolean i = c.add_district_work_city(m);
            if (i == true) {
                full_district();
  ...
  this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new district_work_city().setVisible(true);
            }
        });
    }
