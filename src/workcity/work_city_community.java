 ...
 * @author ahmad-soft
 */
public class work_city_community extends javax.swing.JFrame {

    /**
     * Creates new form district
     */
    public work_city_community() {
        initComponents();

        txt_id.setVisible(false);
        cmb_sub_district.removeAllItems();
//       cmb_district.removeAllItems();
    ...
    public void fullcombobox_Sub_district() {

        int id_governorate = ((m_work_city) cmb_governorate.getSelectedItem()).getId_governorate();
        int id_district = ((m_work_city) cmb_district.getSelectedItem()).getId_district();

        ArrayList<m_work_city> cc = c.view_sub_district_work_city(id_governorate, id_district);
        cmb_sub_district.setModel(new DefaultComboBoxModel(cc.toArray()));
    }

    public void full_viewcommunity_work_city() {
        int id_governorate = ((m_work_city) cmb_governorate.getSelectedItem()).getId_governorate();
        int id_district = ((m_work_city) cmb_district.getSelectedItem()).getId_district();
        int id_sub_district = ((m_work_city) cmb_sub_district.getSelectedItem()).getId_sub_district();

        Control.c_work_city a = new c_work_city();
        ArrayList<m_work_city> cc = a.viewcommunity_work_city(id_governorate, id_district, id_sub_district);
    ...
    private void initComponents() {
        ...
        cmb_sub_district = new RSMaterialComponent.RSComboBoxMaterial();
        ...
        N_type_of_doc_p.setText("الرجاء اختيار محافظة لإضافة بلدة لها");
        ...
        N_type_of_doc_p2.setText("اسم محافظة");
        ...
        N_type_of_doc_p1.setText("الرجاء اختيار منطقة لإضافة بلدة لها");

        N_type_of_doc_p4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        N_type_of_doc_p4.setForeground(new java.awt.Color(7, 2, 2));
        N_type_of_doc_p4.setText("اسم ناحية");

        cmb_sub_district.setBackground(new java.awt.Color(254, 254, 254));
        cmb_sub_district.setForeground(new java.awt.Color(1, 1, 1));
        cmb_sub_district.setToolTipText("");
        cmb_sub_district.setColorMaterial(new java.awt.Color(185, 146, 79));
        cmb_sub_district.setEnabled(false);
        cmb_sub_district.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        cmb_sub_district.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_sub_districtActionPerformed(evt);
            }
        });

        N_type_of_doc_p5.setFont(new java.awt.Font("Arial", 1, 25)); // NOI18N
        N_type_of_doc_p5.setForeground(new java.awt.Color(7, 2, 2));
        N_type_of_doc_p5.setText("الرجاء اختيار ناحية لإضافة بلدة لها");
                ...
                .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnl1Layout.createSequentialGroup()
                        .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(pnl1Layout.createSequentialGroup()
                                .addComponent(cmb_sub_district, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        pnl1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(N_type_of_doc_p4, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cmb_sub_district, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btn_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add1ActionPerformed
        try {
            ...
            m.setId_sub_district(id_sub_district);
            m.setDescription(txt_name.getText());

            boolean i = c.add_community_work_city(m);
            if (i == true) {
                full_viewcommunity_work_city();
    ...
    private void btn_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delActionPerformed
        try {
            if (txt_name.getText() != null && txt_id.getText().equals("")) {
                ...
                //vvnew rojerusan.RSNotifyAnimated("معلومات", "الرجاء اختار الاسم  للحذف عليها", 5, RSNotifyAnimated.PositionNotify.BottomRight, RSNotifyAnimated.AnimationNotify.RightLeft, RSNotifyAnimated.TypeNotify.ERROR).setVisible(true);
                return;
            }
            model_general.setId(Integer.valueOf(txt_id.getText()));
  ...
  this.dispose();
    ...
    private void cmb_districtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_districtActionPerformed
        fullcombobox_Sub_district();
        cmb_sub_district.setEnabled(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_cmb_districtActionPerformed

    private void cmb_sub_districtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_sub_districtActionPerformed

        btn_Next.setEnabled(true);
        // TODO add your handling code here:
    }//GEN-LAST:event_cmb_sub_districtActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new work_city_community().setVisible(true);
            }
        });
    }
    ...
    private RSMaterialComponent.RSComboBoxMaterial cmb_sub_district;
