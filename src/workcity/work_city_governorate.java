 ...
 * @author ahmad-soft
 */
public class work_city_governorate extends javax.swing.JFrame {

    /**
     * Creates new form ministry
     */
    public work_city_governorate() {
        initComponents();
     fill();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("واجهة المحافظة");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new work_city_governorate().setVisible(true);
            }
        });
    }
