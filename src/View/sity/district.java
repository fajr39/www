...
public class district extends javax.swing.JFrame {
    ...
    public void fullcombobox() { 
        ...
        cmb_tyep.setModel(new DefaultComboBoxModel(Lists_Meun.Array_governnorates_1.toArray()));
    }

    public void full_district() {
        int id_state = ((Model_Tables) cmb_tyep.getSelectedItem()).getColumn_Id();

        Control.c_district a = new Control.c_district();
        Model.m_district b = new Model.m_district();
        ArrayList<m_district> cc = a.view_district(id_state);
    ...
    private void initComponents() {
        ...
        cmb_tyep = new RSMaterialComponent.RSComboBoxMaterial();
        ...
        jLabel2.setText("واجهة الأمانة");

        cmb_tyep.setBackground(new java.awt.Color(254, 254, 254));
        cmb_tyep.setForeground(new java.awt.Color(1, 1, 1));
        cmb_tyep.setToolTipText("");
        cmb_tyep.setColorMaterial(new java.awt.Color(185, 146, 79));
        cmb_tyep.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        cmb_tyep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_tyepActionPerformed(evt);
            }
        });

        N_type_of_doc_p.setFont(new java.awt.Font("Arial", 1, 25)); // NOI18N
        N_type_of_doc_p.setForeground(new java.awt.Color(7, 2, 2));
        N_type_of_doc_p.setText("الرجاء اختيار محافظة لإضافة أمانة لها");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                ...
                .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                        ...
                        .addGap(63, 63, 63))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                        .addComponent(cmb_tyep, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void cmb_tyepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_tyepActionPerformed
        // TODO add your handling code here:
        btn_Next.setEnabled(true);
    }//GEN-LAST:event_cmb_tyepActionPerformed
    ...
    private void btn_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add1ActionPerformed
        ...
        try {
            ...
            int id_states = ((Model_Tables) cmb_tyep.getSelectedItem()).getColumn_Id();

            m.setTalbe_name("district");
            m.setName_column1("state_id");
            m.setName_column2("name");
            m.setValue1(String.valueOf(id_states));
            m.setValue2(txt_name.getText());
            boolean i = c.add(m);
            if (i == true) {
                full_district();
            ...
            JOptionPane.showMessageDialog(null, "Error in   frm_district (View) go in frm_district" + ex.getMessage());
        }
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try {
           ...
           // new rojerusan.RSNotifyAnimated("معلومات", "تم تعديل بيانات بنجاح", 5, RSNotifyAnimated.PositionNotify.BottomRight, RSNotifyAnimated.AnimationNotify.RightLeft, RSNotifyAnimated.TypeNotify.SUCCESS).setVisible(true);
            ...
            JOptionPane.showMessageDialog(null, "Error  go -> btnUpdateMouseClicked in frm_district" + ex.getMessage());
        }
    ...
    private void btn_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delActionPerformed
        try {
         ...
         //   new rojerusan.RSNotifyAnimated("معلومات", "تم حذف بيانات بنجاح", 5, RSNotifyAnimated.PositionNotify.BottomRight, RSNotifyAnimated.AnimationNotify.RightLeft, RSNotifyAnimated.TypeNotify.SUCCESS).setVisible(true);
            ...
            JOptionPane.showMessageDialog(null, "Error  go -> btnDeleteMouseClicked in frm_district" + ex.getMessage());
        }
    ...
    private RSMaterialComponent.RSComboBoxMaterial cmb_tyep;
