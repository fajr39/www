 ...
 * @author ahmad-soft
 */
public class registerplace extends javax.swing.JFrame {
    ...
    public void fullcombobox() {
         Lists_Meun.Array_governnorates_1 = Lists_Meun.C_governnorates_1.filltable("district");
        cmb_tyep.setModel(new DefaultComboBoxModel(Lists_Meun.Array_governnorates_1.toArray()));
    }

    public void full_registerplace() {
        int id_district = ((Model_Tables) cmb_tyep.getSelectedItem()).getColumn_Id();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("واجهة مكان القيد");
        ...
        N_type_of_doc_p.setText("الرجاء اختيار الامانة لإضافة مكان القيد لها");
        ...
        jLabel3.setText("واجهة مكان القيد");
    ...
    private void btn_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add1ActionPerformed
        try {
            ...
            int id_states = ((Model.Model_Tables) cmb_tyep.getSelectedItem()).getColumn_Id();
            m.setTalbe_name("registerplace");
            m.setName_column1("name");
            m.setName_column2("district_id");
            m.setValue1(txt_name.getText());
            m.setValue2(String.valueOf(id_states));
            boolean i = c.add(m);
            if (i == true) {
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registerplace().setVisible(true);
            }
        });
    }
