 ...
 * @author ahmad-soft
 */
public class qualification_Name extends javax.swing.JFrame {
    ...
    Model.M_Qualification_Name m = new M_Qualification_Name();
    Control.C_Qualification_Name c= new C_Qualification_Name();
    ...
    public void fill() {
        ...
        for (int i = 0; i < Control.Lists_Meun.Array_Qual_Name.size(); i++) {
            row[0] = Control.Lists_Meun.Array_Qual_Name.get(i).getDescription();
            row[1] = Control.Lists_Meun.Array_Qual_Name.get(i).getId();
            modle.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("واجهة اسم الشهادة");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new qualification_Name().setVisible(true);
            }
        });
    }
