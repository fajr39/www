...
public class directorate extends javax.swing.JFrame {
    ...
    public void full_Direct() {
        ...
        for (int i = 0; i < Lists_Meun.A_Direct.size(); i++) {
            row[0] = Lists_Meun.A_Direct.get(i).getDescription();
            row[1] = Lists_Meun.A_Direct.get(i).getID();
            modle.addRow(row);
        }
        tableDirect.setModel(modle);
    }

    Model.M_Directorates m = new M_Directorates();
    Control.C_Directorates c = new C_Directorates();
    ...
    private void initComponents() {
        ...
        N_type_of_doc_p.setText("الرجاء اختيار وزارة لإضافة مديرية لها");
        ...
        N_type_of_doc_p1.setText("اسم الوزارة");
        ...
        jLabel1.setText("واجهة المديرية");
        pnl2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
        ...
        lbl_name.setText("اسم مديرية");
        pnl2.add(lbl_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 319, -1, -1));
