 ...
 * @author ahmad-soft
 */
public class ministry extends javax.swing.JFrame {
    ...
    Model.M_Ministry m = new M_Ministry();
    Control.C_Ministry c = new C_Ministry();
    
    
  

    public void fill() {
        Control.Lists_Meun.A_Ministry= c.getAllRows();
        DefaultTableModel modle = new DefaultTableModel();
        modle.setColumnIdentifiers(new Object[]{"اسم", "رقم"});
        Object[] row = new Object[2];
        for (int i = 0; i < Control.Lists_Meun.A_Ministry.size(); i++) {
            row[0] = Control.Lists_Meun.A_Ministry.get(i).getDescription();
            row[1] = Control.Lists_Meun.A_Ministry.get(i).getID();
            modle.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 12, 340, 430));
    ...
    private void btn_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delActionPerformed
        ...
        try {
            if (txt_name.getText() != null && txt_id.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "الرجاء اختار الاسم الوزارة للحذف عليها");
                //new rojerusan.RSNotifyAnimated("معلومات", "الرجاء اختار الاسم الوزارة للحذف عليها", 5, RSNotifyAnimated.PositionNotify.BottomRight, RSNotifyAnimated.AnimationNotify.RightLeft, RSNotifyAnimated.TypeNotify.ERROR).setVisible(true);
                return;
            }
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try {
            ...
            if (txt_name.getText() != null && txt_id.getText().equals("")) {
                  JOptionPane.showMessageDialog(null,   "الرجاء اختار الاسم حالة للتعديل عليها");
               // new rojerusan.RSNotifyAnimated("معلومات", "الرجاء اختار الاسم حالة للتعديل عليها", 5, RSNotifyAnimated.PositionNotify.BottomRight, RSNotifyAnimated.AnimationNotify.RightLeft, RSNotifyAnimated.TypeNotify.ERROR).setVisible(true);
                return;
            }
            m.setID(Integer.valueOf(txt_id.getText()));
