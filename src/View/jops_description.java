 ...
 * @author ahmad-soft
 */
public class jops_description extends javax.swing.JFrame {

    /**
     * Creates new form district
     */
    public jops_description() {
        initComponents();
        fullcombobox();
    ...
    Model.m_jops m = new Model.m_jops();
    Control.c_jops c= new c_jops();

    public void fullcombobox() { 
        
        Lists_Meun.array_view_name_jops = Lists_Meun.c_view_name_jops.view_jops();
        cmb_jops.setModel(new DefaultComboBoxModel(Lists_Meun.array_view_name_jops.toArray()));
    }

    public void full_district() {
        int id_jops = ((m_jops) cmb_jops.getSelectedItem()).getTitle();
        
           
        Lists_Meun.Array_view_jops_description = Lists_Meun.c_view_jops_description.view_jops_description(id_jops);
        ...
        for (int i = 0; i < Lists_Meun.Array_view_jops_description.size(); i++) {
            row[0] = Lists_Meun.Array_view_jops_description.get(i).getDescription();
            row[1] = Lists_Meun.Array_view_jops_description.get(i).getId();
            modle.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        cmb_jops = new RSMaterialComponent.RSComboBoxMaterial();
        ...
        jLabel2.setText("واجهة المسمى الوظيفية");

        cmb_jops.setBackground(new java.awt.Color(254, 254, 254));
        cmb_jops.setForeground(new java.awt.Color(1, 1, 1));
        cmb_jops.setToolTipText("");
        cmb_jops.setColorMaterial(new java.awt.Color(185, 146, 79));
        cmb_jops.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        cmb_jops.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_jopsActionPerformed(evt);
            }
        });

        N_type_of_doc_p.setFont(new java.awt.Font("Arial", 1, 25)); // NOI18N
        N_type_of_doc_p.setForeground(new java.awt.Color(7, 2, 2));
        N_type_of_doc_p.setText("الرجاء اختيار الصفة لإضافة المسمى لها");
        ...
        N_type_of_doc_p2.setText("اسم الصفة");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                ...
                .addGroup(pnl1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                        ...
                        .addGap(63, 63, 63))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl1Layout.createSequentialGroup()
                        .addComponent(cmb_jops, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel3.setText("واجهة المسمى  الوظيفية");
        pnl2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, -1, -1));
    ...
    private void cmb_jopsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_jopsActionPerformed
        // TODO add your handling code here:
        btn_Next.setEnabled(true);
    }//GEN-LAST:event_cmb_jopsActionPerformed
...
//
    ...
    private void btn_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add1ActionPerformed
        ...
        try {
            ...
            boolean i = c.add_jops_description(m);
            if (i == true) {
                full_district();
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jops_description().setVisible(true);
            }
        });
    }
    ...
    private RSMaterialComponent.RSComboBoxMaterial cmb_jops;
